...
local M = {
    ...
    { trigger = "pa(%a)(%a)",            replacement = "\\frac{ \\partial [[1]] } { \\partial [[2]] }",                                                                         options = "rmA" },
    { trigger = "pa(%a)(%a)(%a)",        replacement = "\\frac{ \\partial^{2} [[1]] }{ \\partial [[2]] \\partial [[3]] }",                                                      options = "rmA" },
    { trigger = "pa(%a)(%a)2",           replacement = "\\frac{ \\partial^{2} [[1]] }{ \\partial [[2]]^{2} }",                                                                  options = "rmA" },
    { trigger = "de(%a)(%a)",            replacement = "\\frac{ d[[1]] }{ d[[2]] } ",                                                                                           options = "rmA" },
    { trigger = "de(%a)(%a)2",           replacement = "\\frac{ d^{2}[[1]] }{ d[[2]]^{2} } ",                                                                                   options = "rmA" },
    ...
    { trigger = "\\\\bra{([^|]+)\\|",    replacement = "\\braket{ [[1]] | $1 ",                                                                                                 options = "rmA", description = "Convert bra into braket" },
    { trigger = [[\\bra{(.+)}([^ ]+)>]], replacement = "\\braket{ [[1]] | $1 ",                                                                                                 options = "rmA", description = "Convert bra into braket (alternate)" },
    ...
    -- Misc
    { trigger = "tayl",                  replacement = "${1:f}(${2:x} + ${3:h}) = ${1:f}(${2:x}) + ${1:f}'(${2:x})$(3:h) + ${1:f}''(${2:x}) \\frac{${3:h}^{2}}{2!} + \\dots$4", options = "mA" },
}
